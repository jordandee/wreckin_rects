...
SOURCES=main.cpp gib.cpp ball.cpp paddle.cpp block.cpp collision.cpp level1.cpp title.cpp intro.cpp gamestate.cpp timer.cpp globals.cpp image.cpp init.cpp
