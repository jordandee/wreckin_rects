...
Level4::Level4()
{
  ...
  winMessage = TTF_RenderText_Solid(font, "You Win ! ! ! !     Level 4 Complete", blue);
...
void Level4::load_level()
{
  std::ifstream level("level04.txt");
  int stat = 0, i = 0;
...
// gibs yay
void Level4::shatter_block(int B)
{
...
void Level4::logic(Uint32 deltaTime)
{
  ...
  if (blockHit)
  {
    if (timer.get_ticks() - blockLastHitTime > 100)
    {
      switch(blockHits)
      {
        ...
        case 2: Mix_PlayChannel(1,Amin[0],0); break;
        case 3: Mix_PlayChannel(1,Amin[1],0); break;
        case 4: Mix_PlayChannel(1,Amin[2],0); break;
        case 5: Mix_PlayChannel(1,Amin[1],0); break;
        case 6: Mix_PlayChannel(1,Amin[2],0); break;
        case 7: Mix_PlayChannel(1,Amin[3],0); break;
        case 8: Mix_PlayChannel(1,Amin[2],0); break;
        case 9: Mix_PlayChannel(1,Amin[3],0); break;
        case 10: Mix_PlayChannel(1,Amin[4],0); break;
        case 11: Mix_PlayChannel(1,Amin[3],0); break;
        case 12: Mix_PlayChannel(1,Amin[4],0); break;
        case 13: Mix_PlayChannel(1,Amin[5],0); break;
        case 14: Mix_PlayChannel(1,Amin[4],0); break;
        case 15: Mix_PlayChannel(1,Amin[5],0); break;
      }
      blockHits++;
      if (blockHits == 16)
      {
